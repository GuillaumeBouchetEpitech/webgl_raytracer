...
export class ShaderProgram {
    ...
    constructor(opt: IShaderProgramOpts) {
        ...
        const vertexShader = this._getShader(opt.vertexShaderSourceCode, gl.VERTEX_SHADER);
        const fragmentShader = this._getShader(opt.fragmentShaderSourceCode, gl.FRAGMENT_SHADER);
