...
interface IAliasedGeometry {
  geometry: webgl2.GeometryWrapper.Geometry;
  buffer: Float32Array;
  currentSize: number;
}
...
export class GeometryStackRenderer {
  ...
  private _geoDef: webgl2.GeometryWrapper.GeometryDefinition;

  private _aliasedGeometriesMap = new Map<number, IAliasedGeometry>();

  constructor() {
    this._shader = new webgl2.ShaderProgram('GeometryStackRenderer', {
